        ...
        <>
            <div className='min-h-screen shadow-inner pt-4 pb-4' id='Contact'>
                ...
                <div className='flex mt-3'>
                    {/* Contact info */}
                    <div className='w-4/5 lg:w-1/2 m-auto rounded-lg shadow-2xl border p-5 mt-4'>
                        <div className="w-5/4 lg:w-1/2 m-auto">
                        ...
                        <div className="w-5/4 lg:w-1/2 m-auto">
                            ...
                            <div className="flex flex-wrap">
                                <a href="https://github.com/Othmane2378" target="_blank" className="m-auto">
                                    <button className="bg-blue-600 m-3 p-4 rounded-full">
